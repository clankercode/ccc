...
static const RunnerInfo CLAUDE_INFO = {
    ...
    .extra_args_count = 0,
    .thinking = {
        {.args = {"--thinking", "disabled"}, .count = 2},
        {.args = {"--thinking", "enabled", "--effort", "low"}, .count = 4},
        {.args = {"--thinking", "enabled", "--effort", "medium"}, .count = 4},
        {.args = {"--thinking", "enabled", "--effort", "high"}, .count = 4},
        {.args = {"--thinking", "enabled", "--effort", "max"}, .count = 4},
    },
    .provider_flag = "",
    .model_flag = "--model",
    .agent_flag = "--agent",
