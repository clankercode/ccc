            ...
            cases = {
                "Python": [
                    (
                        ...
                        "claude -p --permission-mode default --no-session-persistence Fix the failing tests\n",
                        "",
                    ),
                    (
                    ...
                    (
                        ...
                        "claude -p --permission-mode auto --no-session-persistence Fix the failing tests\n",
                        "",
                    ),
                    (
                    ...
                    (
                        ...
                        "claude -p --permission-mode plan --no-session-persistence Fix the failing tests\n",
                        "",
                    ),
                    (
                        ["k", "--permission-mode", "plan"],
                        "kimi --plan --prompt Fix the failing tests\n",
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            cases = {
                "Python": [
                    (
                        ["cc", ".json"],
                        "claude -p --output-format json --no-session-persistence Fix the failing tests\n",
                    ),
                    (
                        ["cc", "..json"],
                    ...
                    (
                        ["oc", ".json"],
                        "opencode run --format json Fix the failing tests\n",
                    ),
                ],
                "Rust": [
                    (
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            cases = {
                "Python": [
                    (
                        ["cc", ".fmt"],
                        "[assistant] claude -p --verbose --output-format stream-json --no-session-persistence Fix the failing tests\n",
                    ),
                    (
                        ["cc", "..fmt"],
                    ...
                    (
                        ["oc", ".fmt"],
                        "[assistant] opencode run --format json Fix the failing tests\n",
                    ),
                    (
                        ["oc", "..fmt"],
                        "[assistant] opencode run --format json Fix the failing tests\n",
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            cases = {
                "Python": [
                    (
                        ["cc", "--yolo"],
                        "claude -p --dangerously-skip-permissions --no-session-persistence Fix the failing tests\n",
                        "",
                    ),
                    (
                        ["c", "--yolo"],
                    ...
                    (
                        ["k", "-y"],
                        "kimi --yolo --prompt Fix the failing tests\n",
                        KIMI_PERSISTENCE_WARNING,
                    ),
                    (
                        ["cr", "--yolo"],
